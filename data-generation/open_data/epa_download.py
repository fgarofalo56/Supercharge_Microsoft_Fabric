...
CLI::
    ...
    python -m data-generation.open_data.epa_download --dataset aqs --api-key YOUR_KEY --output-dir ./data/epa --state 06
    python -m data-generation.open_data.epa_download --dataset tri --output-dir ./data/epa --year-start 2018 --year-end 2022
    python -m data-generation.open_data.epa_download --dataset all --api-key YOUR_KEY --output-dir ./data/epa
