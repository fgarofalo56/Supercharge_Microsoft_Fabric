...
CLI::
    ...
    python -m data-generation.open_data.sba_download --dataset ppp --output-dir ./data/sba --state CA --sample-size 50000
    python -m data-generation.open_data.sba_download --dataset all --output-dir ./data/sba
