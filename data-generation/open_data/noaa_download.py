...
CLI::
    ...
    python -m data-generation.open_data.noaa_download --dataset storms --output-dir ./data/noaa --start-date 2020 --end-date 2023
    python -m data-generation.open_data.noaa_download --dataset weather --output-dir ./data/noaa --stations KJFK,KLAX
    python -m data-generation.open_data.noaa_download --dataset climate --api-key YOUR_KEY --output-dir ./data/noaa --stations GHCND:USW00094728
