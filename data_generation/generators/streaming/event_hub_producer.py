...
class EventHubProducer:
    ...
    def run_sync(
        ...
        # Create producer once, reuse for all events
        if self._use_eventhub and EVENTHUB_AVAILABLE:
            self._sync_producer = EventHubProducerClient.from_connection_string(
