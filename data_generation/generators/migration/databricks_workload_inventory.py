...
Used by
-------
- `docs/tutorials/42-databricks-to-fabric/01_delta_compatibility.py --mock-mode`
...
def to_yaml(workspace_dict: dict[str, Any], output_dir: str | Path) -> Path:
    ...
    lines = [
        ...
        "# Consumed by docs/tutorials/42-databricks-to-fabric/01_delta_compatibility.py",
        "tables:",
    ]
    for fq in fq_names:
        lines.append(f"  - {fq}")
