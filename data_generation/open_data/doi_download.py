...
CLI::
    ...
    python -m data_generation.open_data.doi_download --dataset earthquakes --output-dir ./data/doi --start-date 2023-01-01 --min-magnitude 4.0
    python -m data_generation.open_data.doi_download --dataset water --output-dir ./data/doi --start-date 2023-06-01 --end-date 2023-06-30
    python -m data_generation.open_data.doi_download --dataset all --output-dir ./data/doi
