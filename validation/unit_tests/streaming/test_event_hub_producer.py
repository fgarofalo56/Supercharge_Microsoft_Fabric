...
class TestEventHubProducer:
    ...
    def test_initialization_defaults(self):
        ...
        assert producer.connection_string is None, "Default connection_string should be None"
        assert producer.eventhub_name is None, "Default eventhub_name should be None"
        assert producer._use_eventhub is False, "Should not use Event Hub without connection string"
    ...
    def test_event_count_property(self, event_hub_producer):
        ...
        assert event_hub_producer.event_count == 0, (
            "Initial event_count should be 0"
        )
    ...
    def test_stdout_mode_with_missing_sdk(self):
        ...
        assert producer is not None, "Producer should initialize regardless of SDK availability"
