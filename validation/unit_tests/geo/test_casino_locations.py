...
class TestCasinoLocations:
    ...
    def test_generate_us_casino_count(self, casino_locations_seeded):
        ...
        assert len(casinos) == 50, (
            f"Expected 50 US casinos, got {len(casinos)}"
        )
    ...
    def test_us_casino_required_fields(self, casino_locations_seeded):
        ...
        required_fields = [
            "casino_id", "name", "brand", "latitude", "longitude",
            "city", "state", "zip_code", "country", "region",
            "property_type", "gaming_sqft", "slot_machines",
            "table_games", "geo_point_wkt",
        ]
    ...
    def test_property_type_valid(self, casino_locations_seeded):
        ...
        casinos = casino_locations_seeded(sample_size_val := 100)
    ...
    def test_generate_global_casino_count(self, global_casino_locations_seeded):
        ...
        assert len(casinos) == 25, (
            f"Expected 25 global casinos, got {len(casinos)}"
        )
