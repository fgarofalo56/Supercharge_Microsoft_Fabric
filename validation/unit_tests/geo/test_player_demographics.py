...
class TestPlayerDemographics:
    ...
    def test_player_required_fields(self, player_demographics_seeded):
        ...
        required_fields = [
            "player_id", "home_casino_id", "home_latitude", "home_longitude",
            "home_city", "home_state", "distance_to_casino_miles",
            "market_type", "age_group", "gender", "income_bracket",
            "visit_frequency", "preferred_gaming", "loyalty_tier",
            "player_segment", "lifetime_value", "geo_point_wkt",
        ]
    ...
    def test_haversine_known_distance(self):
        ...
        assert 220 <= dist <= 275, (
            f"LA-to-LV distance should be ~230 miles, got {dist}"
        )
    ...
    def test_get_loyalty_tier_thresholds(self):
        ...
        assert get_loyalty_tier(300000) == "Seven Stars", "LTV 300000 should be Seven Stars"
